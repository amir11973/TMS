...
export const CompletedTasksModal = ({ isOpen, onClose, items, onShowHistory, onViewDetails }: { isOpen: boolean; onClose: () => void; items: any[], onShowHistory: (item: any) => void; onViewDetails: (item: any) => void; }) => {
