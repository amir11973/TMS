...
import { CollapsibleTableSection, JalaliCalendarView } from '../components';
import { DetailsIcon, HistoryIcon, DelegateIcon, SendIcon, SendForFinishIcon, NotesIcon, CalendarIcon } from '../icons';
        ...
        <div className="tasks-page">
            <div className="page-header-actions">
                <button className="header-action-btn" onClick={() => setViewMode(viewMode === 'list' ? 'calendar' : 'list')}>
                    <CalendarIcon />
                    <span>{viewMode === 'list' ? 'نمای تقویم' : 'نمای لیست'}</span>
                </button>
